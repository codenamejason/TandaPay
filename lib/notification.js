...
class Notification {
    /**
     * @summary: Creates a generic Notification object. Needs only a `tandaID`
    ...
    /**
     * @summary: Placeholder prepare function. Does data fetch in subclasses
     * @returns: void
     */
    async prepare() {}
    ...
    /**
     * @summary: Attempts to deliver the Notification to all members of it's
