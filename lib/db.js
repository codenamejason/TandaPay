...
/**
 * @summary: retrieves a document from the users collection by it's _id. May
...
/**
 * @summary: retrieves a document from the users collection by it's _id. Throws
...
/**
 * @summary: retrieves a document from the tandas collection by it's _id. May
 *           return null when no such document exists.
...
/**
 * @summary: retrieves a document from the tandas collection by it's _id. Throws
 *           if no such document exists
 * @param tandaID: the document's _id
 * @returns: the document
 */
